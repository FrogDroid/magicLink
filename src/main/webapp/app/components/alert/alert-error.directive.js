(function() {
    ...
    function jhiAlertErrorController ($scope, AlertService, $rootScope) {
        ...
        var cleanHttpErrorListener = $rootScope.$on('magicLinkApp.httpError', function (event, httpResponse) {
            var i;
            ...
            case 400:
                var errorHeader = httpResponse.headers('X-magicLinkApp-error');
                var entityKey = httpResponse.headers('X-magicLinkApp-params');
                if (errorHeader) {
